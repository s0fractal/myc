// VENDORED from trinity probes/receipt-envelope-encoder-v0/ts/canonical_cbor.ts so myc
// can sign its own ReceiptEnvelope (substrate sovereignty). Parity-guarded by
// myc/src/shared/envelope_vendor_test.ts + the trinity court's body_hash recompute.

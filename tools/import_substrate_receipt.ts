...
This receipt was deterministically generated by the Genesis physics kernel in response to a liquid PHI_INTENT.
...
> [!SUCCESS]
> Phase verified. Signature: \`${receiptObj.receipt_signature}\`
`;
